...
$description = isset($settings['description']) ? $settings['description'] : 'From intimate boardroom meetings to large-scale conferences, our venues offer world-class facilities equipped with modern technology, flexible spaces, and dedicated event coordinators to ensure your business gathering is a resounding success.';
...
$dropdown_placeholder = isset($settings['dropdown_placeholder']) ? $settings['dropdown_placeholder'] : 'Select a Venue';
...
<div id="conference-info-window-template" style="display: none;">
    ...
    (function () {
        ...
        function definePulseOverlay() {
            ...
            PulseOverlay.prototype.onAdd = function () {
                ...
                if (this.isActive) {
                    ...
                    outerCircle.setAttribute('fill', '#B5D4FF');
                    ...
                    middleCircle.setAttribute('fill', '#8FB8FF');
        ...
        function initConferenceMap() {
            ...
            try {
                ...
                if (hotels.length === 0 && typeof dhrConferenceMapHotels !== 'undefined' && dhrConferenceMapHotels.length) hotels = dhrConferenceMapHotels;
                if (hotels.length === 0 && dhrHotelsData && dhrHotelsData.hotels && dhrHotelsData.hotels.length) hotels = dhrHotelsData.hotels;
            } catch (e) {
                if (typeof dhrConferenceMapHotels !== 'undefined' && dhrConferenceMapHotels.length) hotels = dhrConferenceMapHotels;
            ...
            map = new google.maps.Map(document.getElementById('conference-map'), {
            ...
            google.maps.event.addListenerOnce(map, 'idle', function () {
                if (validHotels.length > 0 && !bounds.isEmpty()) {
                    ...
                    setTimeout(function () {
                        var mapDiv = document.getElementById('conference-map');
                        if (mapDiv) {
        ...
        function getInfoWindowContent(hotel) {
            var templateElement = document.getElementById('conference-info-window-template');
            var template = templateElement.innerHTML;
            var bookNowText = (typeof dhrConferenceMapSettings !== 'undefined' && dhrConferenceMapSettings.book_now_text) ? dhrConferenceMapSettings.book_now_text : 'Get A Quote';
