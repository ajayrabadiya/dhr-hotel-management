        ...
        <div class="dhr-map-row align-items-end">
            <div class="dhr-map-left">
                <div class="dhr-wedding-venue-block">
                    ...
                    <div class="dhr-mobile-hotel-select" id="dhr-wedding-mobile-hotel-select">
                        <select id="dhr-wedding-hotel-dropdown" class="dhr-hotel-dropdown">
...
(function() {
    ...
    function initWeddingVenueMap() {
        ...
        // Initialize map
        map = new google.maps.Map(document.getElementById('dhr-wedding-venue-map'), {
            zoom: 10,
    ...
    function createMarker(hotel, index) {
        ...
        marker.addListener('click', function () {
            ...
            var dropdown = document.getElementById('dhr-wedding-hotel-dropdown');
            if (dropdown) {
    ...
    if (isMobileDevice()) {
        ...
        // Set zoom first
        map.setZoom(15); // changed from 15 to 10
        
        setTimeout(function() {
            var mapDiv = document.getElementById('dhr-wedding-venue-map');
            if (!mapDiv) {
        ...
        map.setCenter(position);
        map.setZoom(10); // changed from 15 to 10
    }
}
