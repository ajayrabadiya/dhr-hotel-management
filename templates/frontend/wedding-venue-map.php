        ...
        <div class="hotel-reservation-info">
            <div class="hotel-phone-section">
                ...
                <div>
                    ...
                    <?php endif; ?>
                    <a class="hotel-phone-number" href="tel:<?php echo esc_html($reservation_phone); ?>" target="_blank">
...
<div id="wedding-venue-info-window-template" style="display: none;">
...
<script>
    (function () {
        ...
        function initWeddingVenueMap() {
            ...
            var mapElement = document.getElementById('wedding-venue-map');
            if (!mapElement) {
            ...
            map = new google.maps.Map(document.getElementById('wedding-venue-map'), {
            ...
            function activateDefaultHotelMarker() {
                var defaultCode = ((typeof dhrWeddingVenueMapSettings !== 'undefined' && dhrWeddingVenueMapSettings.default_hotel_code) || mapElement.getAttribute('data-default-hotel-code') || '').trim();
            ...
            google.maps.event.addListenerOnce(map, 'idle', function () {
                if (validHotels.length > 0 && !bounds.isEmpty()) {
                    ...
                    setTimeout(function () {
                        var mapDiv = document.getElementById('wedding-venue-map');
                        if (mapDiv) {
        ...
        function createMarker(hotel, index) {
            ...
            infoWindow.addListener('closeclick', function () {
                ...
                var dropdown = document.getElementById('wedding-hotel-dropdown');
                if (dropdown) {
                    dropdown.value = '';
                }
            });
        ...
        function getInfoWindowContent(hotel) {
            var templateElement = document.getElementById('wedding-venue-info-window-template');
            var template = templateElement.innerHTML;
            var bookNowText = (typeof dhrWeddingVenueMapSettings !== 'undefined' && dhrWeddingVenueMapSettings.book_now_text) ? dhrWeddingVenueMapSettings.book_now_text : 'Get A Quote';
        ...
        function createNormalMarkerIcon() {
            // Create SVG for normal map marker - wedding venue with 3 lighter shades
            var svg = '<svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg"><circle opacity="0.1" cx="13.068" cy="13.068" r="13.068" fill="#FFB5C5"/><circle opacity="0.3" cx="13.068" cy="13.0681" r="6.0984" fill="#FF8FA8"/><circle cx="13.068" cy="13.0681" r="6.0984" fill="#FE4B67"/></svg>';
        ...
        function createActiveMarkerIcon() {
            // Create SVG for active map marker (more visible) - wedding venue with 3 lighter shades
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (typeof google !== 'undefined' && typeof google.maps !== 'undefined') {
                    ...
                    window.addEventListener('load', function () {
                        setTimeout(initWeddingVenueMap, 1000);
                    });
                }
            });
        } else {
